...
public class AddressTest {
    ...
    public void testAddressFromEither() {
        ...
        assertEquals("BURST-JJQS-MMA4-GHB4-4ZNZU", SignumCrypto.getInstance().getBurstAddressFromPublic(Hex.decode("4A5FA0EE4E40BA8D322EF75963D6B8E71BD206897326CC9683960C9D2FF25966")).getFullAddress());
        assertEquals("BURST-JJQS-MMA4-GHB4-4ZNZU-1UQDBIWHL54TH1HBIK1ZEQWQ3DR4MW6E5B3SNDK1HM9TMLL1T2", SignumCrypto.getInstance().getBurstAddressFromPublic(Hex.decode("4A5FA0EE4E40BA8D322EF75963D6B8E71BD206897326CC9683960C9D2FF25966")).getExtendedAddress());

        assertEquals("BURST-NMXS-ZZS2-3W9L-9UKJP", SignumCrypto.getInstance().getBurstAddressFromPublic(Hex.decode("CB85806964BB888E9AE1C2F27A3DB85D448B84FE9CB2BCCEAFBC49729A03AC16")).getFullAddress());
        assertEquals("BURST-NMXS-ZZS2-3W9L-9UKJP-52M12IVV2RO5B03A568CVA5AO59D0Z1IF8ILFD11CS8M7N3AQE", SignumCrypto.getInstance().getBurstAddressFromPublic(Hex.decode("CB85806964BB888E9AE1C2F27A3DB85D448B84FE9CB2BCCEAFBC49729A03AC16")).getExtendedAddress());
