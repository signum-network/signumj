...
public class CompositeBurstNodeService implements NodeService {
    ...
    public Single<byte[]> generateTransferAssetTransaction(byte[] senderPublicKey, SignumAddress recipient, SignumID assetId, SignumValue quantity, SignumValue amount, SignumValue fee, int deadline) {
        return performFastest(service -> service.generateTransferAssetTransaction(senderPublicKey, recipient, assetId, quantity, amount, fee, deadline));
    }
    ...
    public Single<byte[]> generateTransferAssetMultiTransaction(byte[] senderPublicKey, SignumAddress recipient, Map<SignumID, SignumValue> assets, SignumValue amount, SignumValue fee, int deadline) {
        return performFastest(service -> service.generateTransferAssetMultiTransaction(senderPublicKey, recipient, assets, amount, fee, deadline));
    }
    ...
    public Single<byte[]> generateDistributeToAssetHolders(byte[] senderPublicKey, SignumID assetId,
        ...
        return performFastest(service -> service.generateDistributeToAssetHolders(senderPublicKey, assetId, quantityMinimumQNT, amount, assetToDistribute, quantityQNT, fee, deadline));
    }
    ...
    public Single<byte[]> generateTransferAssetTransactionWithMessage(byte[] senderPublicKey, SignumAddress recipient, SignumID assetId, SignumValue quantity, SignumValue amount, SignumValue fee, int deadline, String message) {
        return performFastest(service -> service.generateTransferAssetTransactionWithMessage(senderPublicKey, recipient, assetId, quantity, amount, fee, deadline, message));
    }
    ...
    public Single<byte[]> generateTransferAssetTransactionWithEncryptedMessage(byte[] senderPublicKey, SignumAddress recipient, SignumID assetId, SignumValue quantity, SignumValue amount, SignumValue fee, int deadline, EncryptedMessage message) {
        return performFastest(service -> service.generateTransferAssetTransactionWithEncryptedMessage(senderPublicKey, recipient, assetId, quantity, amount, fee, deadline, message));
    }
