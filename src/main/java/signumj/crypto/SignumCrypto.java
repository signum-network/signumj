...
public interface SignumCrypto {
     ...
     * @return The encrypted message
     */
    EncryptedMessage encryptBytesMessage(byte[] message, String myPassphrase, byte[] theirPublicKey);
     ...
     * @return The encrypted message
     */
    EncryptedMessage encryptBytesMessage(byte[] message, byte[] myPrivateKey, byte[] theirPublicKey);
     ...
     * @return The encrypted message
     */
    EncryptedMessage encryptTextMessage(String message, String myPassphrase, byte[] theirPublicKey);
     ...
     * @return The encrypted message
     */
    EncryptedMessage encryptTextMessage(String message, byte[] myPrivateKey, byte[] theirPublicKey);
     ...
     * @return The plaintext message
     */
    byte[] decryptMessage(EncryptedMessage message, String myPassphrase, byte[] theirPublicKey);
     ...
     * @return The generation signature of the block
     */
    byte[] calculateGenerationSignature(byte[] lastGenSig, SignumAddress lastGenerator);
     ...
     * @return The hit of that scoop
     */
    BigInteger calculateHit(SignumAddress accountId, long nonce, byte[] genSig, int scoop, int pocVersion);
     ...
     * @return The hit of that scoop
     */
    BigInteger calculateDeadline(SignumAddress accountId, long nonce, byte[] genSig, int scoop, long baseTarget, int pocVersion);
     ...
     */
    static SignumCrypto getInstance() {
        return SignumCryptoImpl.INSTANCE;
    }
}
