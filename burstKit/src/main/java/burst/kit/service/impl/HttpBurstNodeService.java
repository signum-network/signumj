...
public final class HttpBurstNodeService implements BurstNodeService {
    ...
    public HttpBurstNodeService(String nodeAddress, String providedUserAgent) {
        ...
        OkHttpClient okHttpClient = new OkHttpClient.Builder()
                .addInterceptor(
                        chain -> chain.proceed(chain.request().newBuilder().header("User-Agent", userAgent).build()))
                .build();
    ...
    public Single<Block> getBlock(int height) {
        return assign(
                blockchainService.getBlock(BurstKitUtils.getEndpoint(), null, String.valueOf(height), null, false))
                        .map(Block::new);
    }

    @Override
    public Single<Block> getBlock(BurstTimestamp timestamp) {
        return assign(blockchainService.getBlock(BurstKitUtils.getEndpoint(), null, null,
    ...
    public Single<Block[]> getBlocks(int firstIndex, int lastIndex) {
        return assign(blockchainService.getBlocks(BurstKitUtils.getEndpoint(), String.valueOf(firstIndex),
    ...
    public Single<Constants> getConstants() {
        return assign(blockchainService.getConstants(BurstKitUtils.getEndpoint())).map(Constants::new);
    }

    @Override
    public Single<Account> getAccount(BurstAddress accountId) {
        return assign(blockchainService.getAccount(BurstKitUtils.getEndpoint(), accountId.getID())).map(Account::new);
    }
    ...
    public Single<BurstID[]> getAccountBlockIDs(BurstAddress accountId) {
        return assign(
                blockchainService.getAccountBlockIDs(BurstKitUtils.getEndpoint(), accountId.getID(), null, null, null))
    ...
    public Single<Block[]> getAccountBlocks(BurstAddress accountId) {
        return assign(blockchainService.getAccountBlocks(BurstKitUtils.getEndpoint(), accountId.getID(), null, null,
    ...
    public Single<BurstID[]> getAccountTransactionIDs(BurstAddress accountId) {
        return assign(blockchainService.getAccountTransactionIDs(BurstKitUtils.getEndpoint(), accountId.getID(), null,
    ...
    public Single<Transaction[]> getAccountTransactions(BurstAddress accountId) {
        return assign(blockchainService.getAccountTransactions(BurstKitUtils.getEndpoint(), accountId.getID(), null,
                null, null, null, null, null))
    ...
    public Single<AT> getAt(BurstAddress atId) {
        return assign(blockchainService.getAt(BurstKitUtils.getEndpoint(), atId.getID())).map(AT::new);
    }

    @Override
    public Single<BurstAddress[]> getAtIds() {
        return assign(blockchainService.getAtIds(BurstKitUtils.getEndpoint())).map(
    ...
    @Override
    public Single<byte[]> generateTransaction(BurstAddress recipient, byte[] senderPublicKey, BurstValue amount,
    ...
    @Override
    public Single<byte[]> generateTransactionWithEncryptedMessage(BurstAddress recipient, byte[] senderPublicKey,
            BurstValue amount, BurstValue fee, int deadline, BurstEncryptedMessage message) {
        return assign(blockchainService.sendMoney(BurstKitUtils.getEndpoint(), recipient.getID(), null,
                amount.toPlanck().toString(), null, Hex.toHexString(senderPublicKey), fee.toPlanck().toString(),
    ...
    @Override
    public Single<byte[]> generateTransactionWithEncryptedMessageToSelf(BurstAddress recipient, byte[] senderPublicKey,
            BurstValue amount, BurstValue fee, int deadline, BurstEncryptedMessage message) {
        return assign(blockchainService.sendMoney(BurstKitUtils.getEndpoint(), recipient.getID(), null,
                amount.toPlanck().toString(), null, Hex.toHexString(senderPublicKey), fee.toPlanck().toString(),
    ...
    public Observable<MiningInfo> getMiningInfo() {
        ...
        return assign(Observable.interval(0, 1, TimeUnit.SECONDS)
                .flatMapSingle(
                        l -> blockchainService.getMiningInfo(BurstKitUtils.getEndpoint()).map(this::checkBrsResponse))
    ...
    public Single<TransactionBroadcast> broadcastTransaction(byte[] transactionBytes) {
        return assign(
                blockchainService.broadcastTransaction(BurstKitUtils.getEndpoint(), Hex.toHexString(transactionBytes)))
    ...
    public Single<Long> submitNonce(String passphrase, String nonce, BurstID accountId) {
        return assign(blockchainService.submitNonce(BurstKitUtils.getEndpoint(), passphrase, nonce,
    ...
    @Override
    public Single<byte[]> generateMultiOutTransaction(byte[] senderPublicKey, BurstValue fee, int deadline,
            Map<BurstAddress, BurstValue> recipients) throws IllegalArgumentException {
        return Single.fromCallable(() -> {
            ...
            return recipientsString;
                ...
                blockchainService.sendMoneyMulti(BurstKitUtils.getEndpoint(), null, Hex.toHexString(senderPublicKey),
                        fee.toPlanck().toString(), String.valueOf(deadline), null, false, recipientsString.toString()))
                                .map(response -> Hex.decode(response.getUnsignedTransactionBytes())));
    }

    @Override
    public Single<byte[]> generateMultiOutSameTransaction(byte[] senderPublicKey, BurstValue amount, BurstValue fee,
            int deadline, Set<BurstAddress> recipients) throws IllegalArgumentException {
        return Single.fromCallable(() -> {
            StringBuilder recipientsString = new StringBuilder();
            ...
            recipientsString.setLength(recipientsString.length() - 1);
            return recipientsString;
        }).flatMap(recipientsString -> assign(blockchainService.sendMoneyMultiSame(BurstKitUtils.getEndpoint(), null,
    ...
    @Override
    public Single<byte[]> generateCreateATTransaction(byte[] senderPublicKey, BurstValue fee, int deadline, String name,
            String description, byte[] creationBytes) {
        return assign(blockchainService.createATProgram(BurstKitUtils.getEndpoint(), Hex.toHexString(senderPublicKey),
