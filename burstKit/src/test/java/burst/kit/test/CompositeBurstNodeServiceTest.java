...
public class CompositeBurstNodeServiceTest extends BurstNodeServiceTest {
    ...
    protected BurstNodeService getBurstNodeService() {
        BurstNodeService http = new HttpBurstNodeService("https://wallet.burst-alliance.org:8125", "burstkit4j-TEST");
        BurstNodeService grpc = new GrpcBurstNodeService("localhost:6878");
