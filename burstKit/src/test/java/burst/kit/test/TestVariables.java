...
public class TestVariables {
    ...
    public static final BurstAddress EXAMPLE_ACCOUNT_ID = BurstAddress.fromId(new BurstID("7009665667967103287"));
    public static final BurstAddress EXAMPLE_POOL_ACCOUNT_ID = BurstAddress.fromId(new BurstID("888561138747819634"));
