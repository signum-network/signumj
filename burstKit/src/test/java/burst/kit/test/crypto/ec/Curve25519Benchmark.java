package burst.kit.test.crypto.ec;
...
public class Curve25519Benchmark {
    private byte[] sha256(String input) {
        return BurstCrypto.getInstance().getSha256().digest(input.getBytes(StandardCharsets.UTF_8));
    }
    ...
    public void benchmarkJava() {
        benchmark(new Curve25519Impl(() -> BurstCrypto.getInstance().getSha256()), false);
    }
